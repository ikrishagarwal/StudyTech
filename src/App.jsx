    ...
    <section className="bg-white p-8 lg:p-16">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Get access to detailed notes, study materials, and chapter-wise revisions
                  to ensure a deep understanding of every topic.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Benefit from personalized mentorship and live doubt-solving sessions
                  to clarify concepts and stay on track.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Structured learning and focused preparation tools help you excel in
                  exams and achieve your academic goals.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0">
        ...
        <div className="lg:w-1/2">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">BENEFITS OF STUDYTECH</h2>
          <ul className="space-y-4 text-lg">
            <li className="flex items-center">
              <span className="text-white bg-white/20 rounded-full w-6 h-6 flex items-center justify-center mr-2">⭐</span>
      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0">
        {/* Left Section */}
        <div>
          <h2 className="text-2xl font-semibold text-teal-700 mb-4">StudyTech</h2>
        ...
        <div className="flex space-x-16">
          <div>
            ...
            <ul className="text-teal-600 space-y-1">
              <li><a href="#" className="hover:underline">Arjuna Course</a></li>
              <li><a href="#" className="hover:underline">Karma Course</a></li>
              <li><a href="#" className="hover:underline">Eklavya Course</a></li>
            </ul>
          </div>
